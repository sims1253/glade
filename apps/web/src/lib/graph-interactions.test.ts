...
const graph: WorkflowGraph = {
  ...
  nodes: [
    { id: 'source', label: 'Source', kind: 'source', rendererKind: 'data_source', status: 'ok', blockReason: null, obligationCount: 0, raw: {} },
    { id: 'fit', label: 'Fit', kind: 'fit', rendererKind: 'fit', status: 'ok', blockReason: null, obligationCount: 0, raw: {} },
    { id: 'ppc', label: 'PPC', kind: 'ppc', rendererKind: 'diagnostic', status: 'ok', blockReason: null, obligationCount: 0, raw: {} },
  ],
  edges: [
